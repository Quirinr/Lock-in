...
label1 = uilabel(fig, 'Position', [20 150 260 20], 'Text', 'filtered_signal_inphase: ');
label2 = uilabel(fig, 'Position', [20 120 260 20], 'Text', 'filtered_signal_quadrature: ');
label3 = uilabel(fig, 'Position', [20 90 260 20], 'Text', 'R: ');
label4 = uilabel(fig, 'Position', [20 60 260 20], 'Text', 'Theta: ');
